    ...
    <PageLayout>
      <main className="max-w-4xl mx-auto py-20 px-6">
        ...
        <p className="text-center text-zinc-400 text-lg mb-10 max-w-2xl mx-auto">
          ...
          Votes are submitted and counted inside Arcium&apos;s encrypted environment. No one can see how you voted. Not even after results are published. Only the final outcome (e.g. Yes wins or No wins) is revealed; individual votes stay private.
        </p>
        ...
        <div className="space-y-8">
          <section className="section-glow p-6 rounded-xl border border-fuchsia-500/30 bg-fuchsia-500/10">
            ...
            <p className="text-zinc-300 leading-relaxed mb-4">
              ...
              Only when the poll creator runs &quot;Reveal results&quot; is the <strong className="text-zinc-100">final outcome</strong> (Yes or No wins) published on Solana, with proofs that the count is correct. Exact vote counts are not revealed. Only which side won.
            </p>
